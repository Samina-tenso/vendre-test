...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-b6fac9a8.js").then((m) => m.default || m)
  },
  {
    name: "profiles-id",
    path: "/profiles/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-3562dec8.js").then((m) => m.default || m)
  },
  {
    name: "profiles",
    path: "/profiles",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-5ae458bc.js").then((m) => m.default || m)
  }
];
